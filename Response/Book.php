<?php
class AcctByte_Alibris_Response_Book
{
    ...
    public function __construct ($inItem)
    {
        ...
        $this->setTitle((string) $inItem->title);
        $this->setAuthor((string) $inItem->author);
        $this->setBin((string) $inItem->bin);
        $this->setBinding((string) $inItem->binding);
        $this->setComments((string) $inItem->comments);
        $this->setCondition((string) $inItem->condition);
        $this->setCost((string) $inItem->cost);
        $this->setDatePub((string) $inItem->date_pub);
        $this->setEdition((string) $inItem->edition);
        $this->setFlBookCond((string) $inItem->fl_bookcond);
        $this->setFlCover((string) $inItem->fl_cover);
        $this->setFlDustJacket((string) $inItem->fl_dustjacket);
        $this->setFlEdition((string) $inItem->fl_edition);
        $this->setFlJacketCondition((string) $inItem->fl_jacketcond);
        $this->setFlSigned((string) $inItem->fl_signed);
        $this->setIllus((string) $inItem->illus);
        $this->setImageurl((string) $inItem->imageurl);
        $this->setIsbn((string) $inItem->isbn);
        $this->setMediaType((string) $inItem->media_type);
        $this->setKeywords((string) $inItem->keywords);
        $this->setNotes((string) $inItem->notes);
        $this->setPlacePub((string) $inItem->place_pub);
        $this->setPrice((string) $inItem->price);
        $this->setPublisher((string) $inItem->publisher);
        $this->setQtyAvail((string) $inItem->qty_avail);
        $this->setReliablility((string) $inItem->reliability);
        $this->setShiploc((string) $inItem->shiploc);
        $this->setSellercity((string) $inItem->sellercity);
        $this->setSellerstate((string) $inItem->sellerstate);
        $this->setSellercountry((string) $inItem->sellercountry);
        $this->setSellername((string) $inItem->sellername);
        $this->setSellerid((string) $inItem->sellerid);
        $this->setShipping((string) $inItem->shipping);
        $this->setWorkId((string) $inItem->work_id);
